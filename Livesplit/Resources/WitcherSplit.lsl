...
<Layout version="1.6.1">
  ...
  <X>30</X>
  <Y>490</Y>
  <VerticalWidth>278</VerticalWidth>
  ...
  <Components>
    ...
    <Component>
      <Path>WitcherSplit.dll</Path>
      <Settings>
        <Version>1.0.0.0</Version>
        <EnableAutoSplit>True</EnableAutoSplit>
        <SplitOnFacts>True</SplitOnFacts>
        <SplitOnFactsList>q203_druidcamp_disable</SplitOnFactsList>
        <EnableAutoStart>True</EnableAutoStart>
      </Settings>
    </Component>
  </Components>
</Layout>